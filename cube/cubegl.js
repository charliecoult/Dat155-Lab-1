...
class CubeGL {
    ...
    baseCube() {
        ...
        this._gl.uniformMatrix4fv( this.ModelViewMatrixLoc,  false, flatten(this.modelViewMatrix)   );
        this._gl.drawArrays( this._gl.TRIANGLES, 0, this.numVertices );
    }

    upperCube() {
        let scale1 = scale(Scale_Factor, Scale_Factor, Scale_Factor);
        let instanceMatrix = mult( translate( 0.0, 0.575, 0.0 ), scale1);
